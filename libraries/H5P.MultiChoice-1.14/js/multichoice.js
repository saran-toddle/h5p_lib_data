...
H5P.MultiChoice = function (options, contentId, contentData) {
    ...
    self.registerDomElements = function () {
            ...
            if (type === 'H5P.Image') {
                if (media.params.file) {
                    ...
                    self.setImage(media.params.file.path, {
                        disableImageZooming:
                            params.media.disableImageZooming || false,
        ...
        self.setIntroduction(
            '<div id="' + params.label + '">' + params.question + '</div>'
        );
            ...
            if (params.behaviour.singleAnswer) {
                ...
                if ($ans.attr('aria-checked') === 'true') {
                    ...
                    if (
                        ...
                        !params.behaviour.enableRetry
                    ) {
                        return;
                    }

                    // Remove check
                    $ans.removeClass('h5p-selected').attr(
                        'aria-checked',
                        'false'
                    );
                } else {
    ...
    var hideSolution = function ($answer) {
        $answer
            ...
            .find(
                '.h5p-question-plus-one, .h5p-question-minus-one, .h5p-answer-icon, .h5p-solution-icon, .h5p-feedback-dialog'
            )
            .remove();
    };
                ...
                if (params.behaviour.randomAnswers) {
                    ...
                    for (i = 0; i < answersDisplayed.length; i++) {
                        ...
                        $(tip[i])
                            ...
                            .appendTo(
                                $(
                                    answersDisplayed[idMap.indexOf(oldIdMap[i])]
                                ).find('.h5p-alternative-container')
                            );
                    }
                }
            },
    ...
    var calcScore = function () {
        ...
        if (params.behaviour.singlePoint) {
            score =
                (100 * score) / calculateMaxScore() >=
                params.behaviour.passPercentage
                    ? params.weight
                    : 0;
        }
    };
    ...
    var addResponseToXAPI = function (xAPIEvent) {
        ...
        var success =
            (100 * score) / maxScore >= params.behaviour.passPercentage;
